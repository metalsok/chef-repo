...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sokratis-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/bytesrc"
  #   chef.validation_client_name = "bytesrc-validator"
  #   chef.validation_key_path = ".chef/bytesrc-validator.pem"
  # end
end
